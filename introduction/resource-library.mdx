...
<a
  ...
  className="inline-flex items-center gap-1 rounded-md border border-gray-300 px-2 py-px text-xs leading-none font-medium transition-colors hover:bg-gray-50 dark:hover:bg-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-300"
>
  Access the document
</a>
...
<a
  ...
  target="_blank" rel="noopener noreferrer"
  className="ml-2 inline-flex items-center gap-1 rounded-md border border-gray-300 px-2 py-px text-xs leading-none font-medium transition-colors hover:bg-gray-50 dark:hover:bg-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-300"
>
  Access the FAQ
</a>
